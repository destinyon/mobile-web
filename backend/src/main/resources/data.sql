...
ALTER TABLE banners ALTER COLUMN id RESTART WITH 100;

MERGE INTO news (id, category_id, user_id, title, cover_url, summary, author, content, media_url, media_type, source, source_id, source_url, view_count, like_count, favorite_count, comment_count, status)
KEY(id) VALUES
(1, 1, 2, '全英公开赛国羽双面回弹，攻防节奏明显提速', 'https://mobile-web-design.oss-cn-beijing.aliyuncs.com/uploads/312f8966-5d01-4db8-9618-fd653bcbd731.jpg', '全英公开赛进入关键轮次，国羽男双在发接发和后二拍衔接上明显提升。', '熊羽球', '<p>全英公开赛进入关键轮次，国羽男双在发接发和后二拍衔接上明显提升。</p><p>教练组在赛后复盘中提到，轮转速度和连续进攻质量是本场胜负重点。</p><img src="https://mobile-web-design.oss-cn-beijing.aliyuncs.com/uploads/3785e162-8327-4f67-b8a8-fa56e9c449d7.jpg" />', NULL, 'IMAGE', 'LOCAL', 'seed-1', NULL, 201, 222, 18, 2, 'PUBLISHED'),
(2, 2, 2, '三款高端进攻拍横向体验：中杆弹性与连贯性成最大差异', 'https://mobile-web-design.oss-cn-beijing.aliyuncs.com/uploads/fe50236b-e9e8-4f1b-868f-73af881d0af0.jpg', '从连续点杀、平抽挡和后场突击三个场景比较高端进攻拍。', '装备实验室', '<p>本次体验选择三款高端进攻拍，从连续点杀、平抽挡和后场突击三个场景比较。</p><p>中杆弹性和恢复速度直接影响多拍连贯质量。</p>', NULL, 'IMAGE', 'LOCAL', 'seed-2', NULL, 1000, 1000, 31, 1, 'PUBLISHED'),
(3, 3, 1, '周末双打对抗赛报名开启，社区俱乐部将尝试分级编排', 'https://mobile-web-design.oss-cn-beijing.aliyuncs.com/uploads/2025d148-afc4-48fa-83bc-48c6ae0c1289.jpg', '社区球友俱乐部将按水平分组，降低新手参与门槛。', '俱乐部运营组', '<p>本周末双打对抗赛开放报名，社区俱乐部将按水平分组，降低新手参与门槛。</p><p>报名成功后可在我的发布中查看状态。</p>', NULL, 'IMAGE', 'LOCAL', 'seed-3', NULL, 2017, 2222, 52, 0, 'PUBLISHED');

ALTER TABLE news ALTER COLUMN id RESTART WITH 100;
...
ALTER TABLE favorites ALTER COLUMN id RESTART WITH 100;
